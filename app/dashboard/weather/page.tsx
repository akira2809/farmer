    ...
    <div className="bg-[#fffcf6] flex flex-col md:flex-row items-start relative min-h-screen w-full overflow-hidden">
      ...
      <div className="flex flex-[1_0_0] flex-col gap-[30px] md:gap-[40px] h-full items-center min-h-px min-w-px overflow-clip relative shrink-0 w-full md:ml-[60px] lg:ml-[72px]">
        ...
        <div className="w-full px-[25px] md:px-[35px] pb-[25px]">
          <div className="relative w-full h-[80vh] rounded-[14.09px] border-2 border-[#2e8623] overflow-hidden shadow-lg">
            {/* Map Background */}
            ...
            <div className="absolute bottom-0 right-0 p-[20px] md:p-[30px] z-10 w-full md:w-auto pointer-events-none flex justify-end">
              <div className="bg-[#fffcf6]/95 backdrop-blur-sm border-2 border-[#2e8623] border-solid relative rounded-[14.09px] shrink-0 w-[360px] h-[420px] pointer-events-auto shadow-xl flex flex-col">
